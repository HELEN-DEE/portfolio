...
const Hero = () => {
    ...
    return (
        <section 
            id="home" 
            className={`min-h-screen flex items-center relative overflow-hidden pt-16 pb-16 transition-colors duration-300 ${
                theme === 'dark' 
        ...
        >
            <div className="container mx-auto px-6 lg:px-12 max-w-7xl relative z-10">
                ...
                {/* <motion.div 
                    className={`mt-16 pt-8 border-t flex flex-wrap items-center gap-8 text-sm transition-colors duration-300 ${
                        theme === 'dark' 
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                            <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-colors duration-300 ${
                                theme === 'dark'
                                    ? 'bg-[#4c1d95] border-slate-950'
                                    : 'bg-[#f3e8ff] border-white'
                            }`}>
                                <span className={`text-xs font-bold ${
                                    theme === 'dark' ? 'text-purple-300' : 'text-[#7c3aed]'
                                }`}>5+</span>
                            </div>
