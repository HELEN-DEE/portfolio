...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex items-center relative overflow-hidden pt-24 pb-16"
    >
      ...
      <div className="absolute right-8 top-1/4 opacity-5 dark:opacity-10">
        <div className="w-24 h-24 border border-slate-400 rounded-full animate-pulse"></div>
      </div>
      <div className="absolute right-16 bottom-1/4 opacity-5 dark:opacity-10">
        <div className="w-16 h-16 border border-slate-400 rounded-full animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl relative z-10">
        <div className="space-y-12">
          ...
          >
            {/* Status badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 backdrop-blur-sm">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 dark:text-white leading-[1.1] tracking-tight">
                Web Developer
                <br />
                <span className="text-slate-600 dark:text-slate-400">building digital</span>
                <br />
          ...
          <motion.div 
            className="pt-8 flex flex-wrap items-center gap-8 text-sm text-slate-700 dark:text-slate-400"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-[#f3e8ff] dark:bg-[#4c1d95] border-2 border-white dark:border-slate-950 flex items-center justify-center">
                  <span className="text-xs font-bold text-[#7c3aed] dark:text-purple-300">5+</span>
                </div>
                <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-800 border-2 border-white dark:border-slate-950"></div>
                <div className="w-8 h-8 rounded-full bg-slate-300 dark:bg-slate-700 border-2 border-white dark:border-slate-950"></div>
              </div>
